            ...
            <nav>
                ...
                <div className={classes.hamburgerMenu}>
                    <Menu>
                        ...
                        />
                        <MenuList>
                            <MenuItem as='a' href='/' icon={<AddIcon />}>
                                Home
                            </MenuItem>
                            <MenuItem as='a' href='/Services' icon={<ExternalLinkIcon />}>
                                Services
                            </MenuItem>
                            <MenuItem as='a' href='/Gallery' icon={<RepeatIcon />}>
                                Gallery
                            </MenuItem>
                            <MenuItem as='a' href='/contact' icon={<EditIcon />}>
                                Contact Us
                            </MenuItem>
                        </MenuList>
                    </Menu>
